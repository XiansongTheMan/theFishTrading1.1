<!--
  ...
  category 对应 red, remind, hk, announcement, fund, watch
-->
...
import { cailiansheTest } from "@/news/api/cailianshe";
import { typeOptions, defaultTypeVal } from "@/news/config/cailianshe";
...
async function handleTest() {
  ...
  try {
    const res = (await cailiansheTest({
