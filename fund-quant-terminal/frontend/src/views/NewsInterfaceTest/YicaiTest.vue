...
import { yicaiTest } from "@/news/api/yicai";
import { typeOptions, defaultTypeVal } from "@/news/config/yicai";
...
async function handleTest() {
  ...
  loadingInstance = ElLoading.service({
    lock: true,
    text: "请求第一财经 news API...",
    background: "rgba(0,0,0,0.4)",
  });
  try {
    const res = (await yicaiTest({
