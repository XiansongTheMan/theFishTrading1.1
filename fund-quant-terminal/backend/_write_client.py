#!/usr/bin/env python3
"""Temporary script to write wallstreetcn_client.py"""
p = __file__.replace("_write_client.py", "app/services/wallstreetcn_client.py")
c = r'''# =====================================================
# 华尔街见闻 API 客户端
